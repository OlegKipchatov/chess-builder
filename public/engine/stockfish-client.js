...
import {stockfishProfile,validEngineProfile} from './strength.js';
...
export const createStockfish19Client = () => createStockfishClient(()=>new Worker('./stockfish19-worker.js',{type:'module'}));
