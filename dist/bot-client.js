...
import {createStockfishClient} from './stockfish-client.js?v=35';
...
export const createBotClient = (profile,{spawn=()=>new Worker('./bot-worker.js?v=35',{type:'module'}),native=()=>createStockfishClient()}={}) => {
