...
import {createStockfishClient} from './stockfish-client.js?v=32';
...
export const createBotClient = (profile,{spawn=()=>new Worker('./bot-worker.js?v=32',{type:'module'}),native=()=>createStockfishClient()}={}) => {
