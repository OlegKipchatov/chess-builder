...
import {createStockfishClient} from './stockfish-client.js?v=26';
...
export const createBotClient = (profile,{spawn=()=>new Worker('./bot-worker.js?v=26',{type:'module'}),native=()=>createStockfishClient()}={}) => {
