...
import {createStockfishClient} from './stockfish-client.js?v=25';
...
export const createBotClient = (profile,{spawn=()=>new Worker('./bot-worker.js?v=25',{type:'module'}),native=()=>createStockfishClient()}={}) => {
