...
import {createStockfishClient} from './stockfish-client.js?v=36';
...
export const createBotClient = (profile,{spawn=()=>new Worker('./bot-worker.js?v=36',{type:'module'}),native=()=>createStockfishClient()}={}) => {
