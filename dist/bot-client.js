...
import {createStockfishClient} from './stockfish-client.js?v=31';
...
export const createBotClient = (profile,{spawn=()=>new Worker('./bot-worker.js?v=31',{type:'module'}),native=()=>createStockfishClient()}={}) => {
