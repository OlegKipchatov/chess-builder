...
import {createStockfishClient} from './stockfish-client.js?v=42';
...
export const createBotClient = (profile,{spawn=()=>new Worker('./bot-worker.js?v=42',{type:'module'}),native=()=>createStockfishClient()}={}) => {
