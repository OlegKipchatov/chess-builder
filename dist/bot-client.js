...
import {createStockfishClient} from './stockfish-client.js?v=27';
...
export const createBotClient = (profile,{spawn=()=>new Worker('./bot-worker.js?v=27',{type:'module'}),native=()=>createStockfishClient()}={}) => {
