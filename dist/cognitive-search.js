import {CONVERSION} from './conversion-config.js?v=35';
import {conversionSignature} from './conversion-model.js?v=35';
import {decideConversion} from './conversion-search.js?v=35';
import {Chess} from './chess.js?v=35';
import {CONFIG as C} from './cognitive-config.js?v=35';
import {capabilitiesFor,factsFor,threatsFor,perceive,random,uci,boardPieces} from './cognitive-model.js?v=35';
import {profileAdjustment} from './cognitive-profile.js?v=35';
import {validPlayStyle} from './play-style-config.js?v=35';
