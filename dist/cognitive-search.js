import {CONVERSION} from './conversion-config.js?v=42';
import {conversionSignature} from './conversion-model.js?v=42';
import {decideConversion} from './conversion-search.js?v=42';
import {Chess} from './chess.js?v=42';
import {CONFIG as C} from './cognitive-config.js?v=42';
import {capabilitiesFor,factsFor,threatsFor,perceive,random,uci,boardPieces} from './cognitive-model.js?v=42';
import {profileAdjustment} from './cognitive-profile.js?v=42';
import {validPlayStyle} from './play-style-config.js?v=42';
