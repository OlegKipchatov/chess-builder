import {CONVERSION} from './conversion-config.js?v=36';
import {conversionSignature} from './conversion-model.js?v=36';
import {decideConversion} from './conversion-search.js?v=36';
import {Chess} from './chess.js?v=36';
import {CONFIG as C} from './cognitive-config.js?v=36';
import {capabilitiesFor,factsFor,threatsFor,perceive,random,uci,boardPieces} from './cognitive-model.js?v=36';
