...
import {CONFIG as C} from './cognitive-config.js?v=26';
import {capabilitiesFor,factsFor,threatsFor,perceive,random,uci,boardPieces} from './cognitive-model.js?v=26';
import {profileAdjustment} from './cognitive-profile.js?v=26';
import {validPlayStyle} from './play-style-config.js?v=26';
