import {CONVERSION} from './conversion-config.js?v=40';
import {conversionSignature} from './conversion-model.js?v=40';
import {decideConversion} from './conversion-search.js?v=40';
import {Chess} from './chess.js?v=40';
import {CONFIG as C} from './cognitive-config.js?v=40';
import {capabilitiesFor,factsFor,threatsFor,perceive,random,uci,boardPieces} from './cognitive-model.js?v=40';
