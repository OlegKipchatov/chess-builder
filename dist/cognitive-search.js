...
import {CONFIG as C} from './cognitive-config.js?v=27';
import {capabilitiesFor,factsFor,threatsFor,perceive,random,uci,boardPieces} from './cognitive-model.js?v=27';
import {profileAdjustment} from './cognitive-profile.js?v=27';
