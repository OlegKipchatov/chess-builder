import {STOCKFISH as C} from './stockfish-config.js?v=27';
import {parseInfo,completeCandidates,prepareCandidates} from './candidate-analysis.js?v=27';
import {Chess} from './chess.js?v=27';
import {validEngineProfile} from './strength.js?v=27';
...
export const createStockfishClient = (spawn=()=>new Worker('./stockfish19-worker.js?v=27',{type:'module'})) => {
