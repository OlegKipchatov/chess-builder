...
import {stockfishProfile,validEngineProfile} from './strength.js?v=10';
...
export const createStockfish19Client = () => createStockfishClient(()=>new Worker('./stockfish19-worker.js?v=10',{type:'module'}));
