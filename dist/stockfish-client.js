import {STOCKFISH as C} from './stockfish-config.js?v=35';
import {parseInfo,completeCandidates,prepareCandidates} from './candidate-analysis.js?v=35';
...
export const createStockfishClient = (spawn=()=>new Worker('./stockfish19-worker.js?v=35',{type:'module'})) => {
