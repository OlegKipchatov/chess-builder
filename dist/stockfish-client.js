...
import {stockfishProfile,validEngineProfile} from './strength.js?v=9';
...
export const createStockfish19Client = () => createStockfishClient(()=>new Worker('./stockfish19-worker.js?v=9',{type:'module'}));
