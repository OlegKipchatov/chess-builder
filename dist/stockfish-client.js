import {STOCKFISH as C} from './stockfish-config.js?v=25';
import {parseInfo,completeCandidates,prepareCandidates} from './candidate-analysis.js?v=25';
import {Chess} from './chess.js?v=25';
import {validEngineProfile} from './strength.js?v=25';
...
export const createStockfishClient = (spawn=()=>new Worker('./stockfish19-worker.js?v=25',{type:'module'})) => {
