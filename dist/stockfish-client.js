import {STOCKFISH as C} from './stockfish-config.js?v=28';
import {parseInfo,completeCandidates,prepareCandidates} from './candidate-analysis.js?v=28';
...
export const createStockfishClient = (spawn=()=>new Worker('./stockfish19-worker.js?v=28',{type:'module'})) => {
