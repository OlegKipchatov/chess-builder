import {STOCKFISH as C} from './stockfish-config.js?v=26';
import {parseInfo,completeCandidates,prepareCandidates} from './candidate-analysis.js?v=26';
import {Chess} from './chess.js?v=26';
import {validEngineProfile} from './strength.js?v=26';
...
export const createStockfishClient = (spawn=()=>new Worker('./stockfish19-worker.js?v=26',{type:'module'})) => {
