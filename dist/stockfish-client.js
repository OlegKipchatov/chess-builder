import {STOCKFISH as C} from './stockfish-config.js?v=36';
import {parseInfo,completeCandidates,prepareCandidates} from './candidate-analysis.js?v=36';
...
export const createStockfishClient = (spawn=()=>new Worker('./stockfish19-worker.js?v=36',{type:'module'})) => {
