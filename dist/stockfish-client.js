import {STOCKFISH as C} from './stockfish-config.js?v=40';
import {parseInfo,completeCandidates,prepareCandidates} from './candidate-analysis.js?v=40';
...
export const createStockfishClient = (spawn=()=>new Worker('./stockfish19-worker.js?v=40',{type:'module'})) => {
