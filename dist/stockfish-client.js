import {STOCKFISH as C} from './stockfish-config.js?v=29';
import {parseInfo,completeCandidates,prepareCandidates} from './candidate-analysis.js?v=29';
...
export const createStockfishClient = (spawn=()=>new Worker('./stockfish19-worker.js?v=29',{type:'module'})) => {
