import {STOCKFISH as C} from './stockfish-config.js?v=42';
import {parseInfo,completeCandidates,prepareCandidates} from './candidate-analysis.js?v=42';
...
export const createStockfishClient = (spawn=()=>new Worker('./stockfish19-worker.js?v=42',{type:'module'})) => {
