import {initialActivity, normalizeActivity} from './activity.js?v=42';
import {validArchivedProfile,migrateEngineProfile} from './strength.js?v=42';
import {initialRating, normalizeRating, validRatingSnapshot, ratingSnapshot} from './rating.js?v=42';
import {Chess} from './chess.js?v=42';
import {TYPES, STYLES, ITEMS, baseInventory, defaultEquipment, pieceId, boardId, itemById} from './catalog.js?v=42';
