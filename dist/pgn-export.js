import {playStyleName} from './play-style-config.js?v=29';
...
export const exportPgn = (game,config={},error=null) => {
 ...
 const headers={...(config.counted===false?{Termination:'abandoned'}:{}),Event:'GachaChess',Site:'https://olegkipchatov.github.io/chess-builder/',White:color==='w'?'Player':botName,Black:color==='b'?'Player':botName,Result:result,GachaChessVersion:'0.3-v29',CurrentFEN:copy.fen()};
