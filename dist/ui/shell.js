import {appHeader} from './components/app-header.js?v=31';
import {bottomNavigation} from './components/bottom-navigation.js?v=31';
import {playPage} from './pages/play.js?v=31';
import {profilePage} from './pages/profile.js?v=31';
import {collectionPage} from './pages/collection.js?v=31';
import {chestsPage} from './pages/chests.js?v=31';
import {archivePage} from './pages/archive.js?v=31';
import {statisticsPage} from './pages/statistics.js?v=31';
import {calendarPage} from './pages/calendar.js?v=31';
import {faqPage} from './pages/faq.js?v=31';
