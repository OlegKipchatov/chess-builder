import {TYPES,PIECE_NAMES,STYLES,ITEMS,itemById,craftCost} from '../../catalog.js?v=32';
import {pieceSVG,itemPreview} from '../../pieces.js?v=32';
import {presetEquipment} from '../../collection-model.js?v=32';
import {button,sectionHeader,emptyState,escapeHTML} from '../primitives.js?v=32';
import {equipmentPreview,equipmentRow,savedSetRow,rarityLabel} from './equipment.js?v=32';
...
const savedSets = state => sectionHeader({title:`Мои наборы ${state.sets.length}/12`})+(state.sets.length?`<div class="collection-list">${state.sets.map(savedSetRow).join('')}</div>`:emptyState('Сохраните выбранные фигурки и доску как свой набор.'));
